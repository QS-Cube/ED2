...
Here $J^{\alpha}_{r r^{\prime}}, D^{\alpha}_{r r^{\prime}}, \Gamma^{\alpha}_{r r^{\prime}}$ denote exchange, Dzyaloshinskii--Moriya, and symmetric anisotropic interactions between spins on sites $r, r^{\prime}$, while $\mathbf h_r$ represents local Zeeman fields.
