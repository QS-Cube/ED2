...
Here \\(J^{\\alpha}_{rr'}\\), \\(D^{\\alpha}_{rr'}\\), and \\(\\Gamma^{\\alpha}_{rr'}\\) denote exchange, Dzyaloshinskii–Moriya, and symmetric anisotropic interactions between spins on sites \\(r,r'\\), while \\(\\mathbf h_r\\) represents local Zeeman fields.
Local spin magnitudes \\(S_r = 1/2, 1, 3/2, \\ldots\\) may be specified independently at each site.
...
[1] QS3 quantum spin solver (precursor of ED2).  
[2] A. E. Ferdinand and M. E. Fisher, Phys. Rev. 185, 832 (1969).  
[3] D. P. Landau, Phys. Rev. B 13, 2997 (1976).  
[4] K. Binder, Phys. Rev. Lett. 47, 693 (1981).  
[5] D. P. Landau and K. Binder, Phys. Rev. B 31, 5946 (1985).  
[6] V. Privman, Finite Size Scaling and Numerical Simulation of Statistical Systems, World Scientific (1990).  
[7] K. Nomura and K. Okamoto, J. Phys. A 27, 5773 (1994).  
[8] K. Nomura, J. Phys. A 28, 5451 (1995).  
[9] A. Kitazawa, J. Phys. A 30, L285 (1997).  
[10] K. Nomura and A. Kitazawa, J. Phys. A 31, 7341 (1998).