...
**honeycomb‑lattice quantum spin system** with periodic boundary conditions.
...
This example illustrates calculations on a **bipartite two‑dimensional lattice**
using QS³‑ED2.
...
This example demonstrates a **honeycomb‑lattice quantum spin model**
